...
def test_ihdp_with_min_leaf_size():
    ...
    param_function = lambda d: lambda: Experiment() \
        ...
        .add_mean_squared_error() \
        .add_ihdp_npci()
    Parameterizer(param_function, leaf_size, name=f'leaf_size_ihdp_general').run(save_graphs=True, epochs=200)
...
def test_ihdp_with_max_depth():
    ...
    param_function = lambda d: lambda: Experiment() \
        ...
        .add_mean_squared_error() \
        .add_ihdp_npci()
    Parameterizer(param_function, leaf_size, name=f'max_depth_ihdp_general').run(save_graphs=True, epochs=200)
...
def parameterize_sample_size_biased():
    ...
    Parameterizer(param_function, sample_sizes, name='sample_size_biased_general').run(save_graphs=True, epochs=200)
    Parameterizer(param_function, sample_sizes, name='sample_size_biased_specific').run_specific(
        ...
        pd.DataFrame(np.zeros((10, 1)) + 0.1, columns=['outcome']), epochs=200)
...
def parameterize_sample_size_general():
    ...
    Parameterizer(param_function, sample_sizes, name='sample_size_normal_general').run(save_graphs=True, epochs=200)
...
def parameterize_min_leaf_general():
    ...
    Parameterizer(param_function, leaf_size, name='min_leaf_normal_general').run(save_graphs=True, epochs=200)
...
def parameterize_number_of_trees():
    ...
    Parameterizer(param_function, tree_numbers, name='number_of_trees_biased_general').run(epochs=200)
    Parameterizer(param_function, tree_numbers, name='number_of_trees_biased_specific').run_specific(
        ...
        pd.DataFrame(np.zeros((40, 1)) + 0.1, columns=['outcome']), epochs=200)
...
def parameterize_leaf_size():
    ...
    param_function = lambda d: lambda: Experiment() \
        ...
        .add_mean_squared_error() \
        .add_full_biased_generator(dimensions=dimensions)
    Parameterizer(param_function, leaf_size, name='leaf_size_biased_general').run(save_graphs=True, epochs=200)
    Parameterizer(param_function, leaf_size, name='leaf_size_biased_specific').run_specific(
        pd.DataFrame(np.zeros((40, 5)), columns=[f'feature_{i}' for i in range(dimensions)]),
        pd.DataFrame(np.zeros((40, 1)) + 0.1, columns=['outcome']), save_graphs=True, epochs=200)
...
def parameterize_specific_spiked_min_leaf():
    ...
    Parameterizer(param_function, leaf_size, name='min_leaf_spiked_general').run(save_graphs=True, epochs=200)
    Parameterizer(param_function, leaf_size, name='min_leaf_spiked_specific').run_specific(
        ...
        pd.DataFrame(np.zeros((40, 1)) + 15.915494309189528, columns=['outcome']), save_graphs=True, epochs=200)
...
def parameterize_specific_spiked_sample_size():
    ...
    Parameterizer(param_function, sample_sizes, name='sample_size_spiked_general').run(save_graphs=True, epochs=200)
